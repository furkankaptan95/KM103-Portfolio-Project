...
public class AddPersonalInfoViewModel
{
    ...
    [MaxLength(50, ErrorMessage = "İsim kısmı en fazla 50 karakter olabilir.")]
    public string Name { get; set; }

    [Required(ErrorMessage = "Soyisim kısmı zorunludur.")]
    [MaxLength(50, ErrorMessage = "Soyisim kısmı en fazla 50 karakter olabilir.")]
    public string Surname { get; set; }

    [Required(ErrorMessage = "Hakkımda kısmı zorunludur.")]
    [MaxLength(300, ErrorMessage = "Hakkımda kısmı en fazla 300 karakter olabilir.")]
